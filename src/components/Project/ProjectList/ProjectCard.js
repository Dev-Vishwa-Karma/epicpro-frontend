...
class ProjectCard extends Component {
    ...
    componentDidMount() {
        ...
        this.setState({
            isCollapsed: Number(this.props.project.project_is_active) === 0
        });
    }
                        ...
                        <div className="card-options">
                            <label className="custom-switch m-0">
                                <input
                                    ...
                                    onChange={() =>
                                        onToggleStatus && onToggleStatus(project.project_id, project.project_is_active)
                                    }
                                />
                                    ...
                                    <div className="dropdown d-flex">
                                        ...
                                        >
                                            ...
                                            <button
                                                ...
                                                type="button"
                                                title="Delete"
                                                onClick={() => onDeleteProject && onDeleteProject(project.project_id, project.project_name)}
                                                style={{
                                                    color: '#d9534f'
                                                }}
                                            >
                        ...
                        <div className="row">
                            ...
                            <div className="col-8 py-1">
                                <div style={{ display: 'flex', alignItems: 'center' }}>
                                    {project.team_members && project.team_members.map((member, idx) => (
                                        <img
